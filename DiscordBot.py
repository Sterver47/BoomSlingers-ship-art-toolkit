...
async def send_art_image(message):
    ...
    if len(art_strings) > 2:
        ...
        await message.channel.send(
            "Hey! You've sent too many art codes in one message. My Creator decided that I can't convert that many art codes at once, so I will convert only the first two of them. I'm sincerely sorry for his bad decision. :pensive:")
    ...
    for art_string in art_strings:
        ...
        try:
            ...
            await message.channel.send(
                f"Unfortunately, I've struggled with converting the art code you shared into an image. Please, try to paste it into the in-game paint shop and if it works there, report it to my Creator: Sterver#0769. He probably messed something up in my code... :man_facepalming: The art code I failed to convert was:")
